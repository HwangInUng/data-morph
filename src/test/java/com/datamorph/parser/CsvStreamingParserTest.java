...
class CsvStreamingParserTest {
    ...
    class ParserFactoryIntegrationTest {
        ...
        void parserFactoryConfirmsCsvStreamingSupport() {
            // when & then
            assertThat(ParserFactory.supportsStreamingParsing(com.datamorph.core.Format.CSV)).isTrue();
        }
        ...
        void parserFactoryReturnsRecommendedBufferSize() {
            // when
            int bufferSize = ParserFactory.getRecommendedBufferSize(com.datamorph.core.Format.CSV);
